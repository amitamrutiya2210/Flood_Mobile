...
void main() {
  group('PowerManagementBloc', () {
    ...
    blocTest<PowerManagementBloc, PowerManagementState>(
      'emits the correct state when SetKeepCpuAwakeEvent is added',
      build: () => powerManagementBloc,
      act: (bloc) => bloc.add(SetKeepCpuAwakeEvent(keepCpuAwake: true)),
      expect: () => [
        PowerManagementState.initial().copyWith(keepCpuAwake: true),
      ],
    );
